...
import type { FileNavigationState, FileItem, SortConfig, FilterOptions } from "../types/index.js";
...
export const useFileNavigation = (
  ...
  const goToParent = useCallback(async () => {
    const parentResult = deps.fileSystemService.getParentPath(state.currentPath);
    if (parentResult.ok) {
