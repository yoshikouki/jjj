 ...
 */
const createNavigationHandler = (navigation: UseFileNavigationReturn["actions"]): KeyHandler => {
 ...
 */
const createSortHandler = (navigation: UseFileNavigationReturn["actions"]): KeyHandler => {
 ...
 */
export const useKeyboardInput = ({ navigation, onExit }: UseKeyboardInputOptions): void => {
